...
private:
  ...
  uint32_t _sdaBitMaskIOCR;
  uint32_t _sclBitMask;
  uint32_t _sclBitMaskIOCR;
  
  volatile uint32 *_sdaPortReg;
  volatile uint32 *_sclPortReg;
  volatile uint32 *_sdaDirReg;
  volatile uint32 *_sclDirReg;
  volatile uint32 *_sdaPinReg;
  volatile uint32 *_sclPinReg;
