...
*           (Infineon TriBoard-TC275C board)
*
...
#define BOARD_NAME				"TriBoard-TC275C"
...
/*
	NOTE: This include of <tc27xb/IfxPort_reg.h> must be after the extern "C" declaration,
	because <tc27xb/IfxPort_reg.h> has not its own extern "C" declaration.
*/
#include <tc27xc/IfxPort_reg.h>
#include <tc27xc/IfxPort_bf.h>

static Ifx_P * const portLED = (Ifx_P *)&MODULE_P33;

/* TriBoard-TC275B : P33.6 ... P33.13 --> LED D501 ... D508 */
