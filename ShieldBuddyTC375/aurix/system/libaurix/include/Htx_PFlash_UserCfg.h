 ...
 * \file        Htx_PFlash_UserCfg.h
 * \brief       PFlash driver user configuration file
 * \details     PFlash driver user configuration file
 * \author      Hitex (UK) Ltd
...
#ifndef HTX_PFLASH_USERCFG_H
#define HTX_PFLASH_USERCFG_H
...
/* Flash sector protection check */
#define HTX_PFLASH_LOCKCHECK_ENABLE
