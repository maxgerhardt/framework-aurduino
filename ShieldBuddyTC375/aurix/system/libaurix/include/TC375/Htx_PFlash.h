 ...
 ******************************************************************************
 ******************************************************************************
 *  Project     4327.AURIX_BootLoader
 * \file        Htx_PFlash.h
 * \brief       PFlash driver header file
 * \details     PFlash driver header file
 * \author      Hitex (UK) Ltd
 * \date        \$LastChangedDate:: 2020-02-14 #$
 * \version     \$Revision: 24026 $
...
extern Htx_PFlash_ReturnType Htx_PFlash_Erase(Htx_PFlash_AddressType TargetAddress,
                                              Htx_PFlash_LengthType Length,
											  uint32 *FSR);
extern Htx_PFlash_ReturnType Htx_PFlash_GetEccError(void);
extern void Htx_PFlash_ClearStatus(void);
extern uint32 Htx_PFlash_ReadERRSR(void);
