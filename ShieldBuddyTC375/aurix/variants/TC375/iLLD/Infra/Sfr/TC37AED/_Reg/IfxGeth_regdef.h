...
typedef volatile struct _Ifx_GETH_MTL_TXQ0
{
       ...
       Ifx_GETH_MTL_TXQ0_UNDERFLOW         GETH_UNDERFLOW;              /**< \brief 4, MTL Queue 0 Transmit Underflow Counter Register*/
...
typedef volatile struct _Ifx_GETH_MTL_TXQ
{
       ...
       Ifx_GETH_MTL_TXQ_UNDERFLOW          GETH_UNDERFLOW;              /**< \brief 4, MTL Queue ${i} Transmit Underflow Counter Register*/
