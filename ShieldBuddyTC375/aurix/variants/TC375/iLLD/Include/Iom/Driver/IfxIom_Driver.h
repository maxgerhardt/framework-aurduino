 ...
 *  \endcode
 *
 *  The below picture shows an overview of the configuration variables with the link to the related hardware part:
 *  \image html "TC.Iom.Driver.Driver[Overview].png" "IOM Driver overview"
 *
