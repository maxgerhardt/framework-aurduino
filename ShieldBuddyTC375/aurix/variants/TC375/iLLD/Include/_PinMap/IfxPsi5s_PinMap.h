...
IFX_EXTERN IfxPsi5s_Clk_Out IfxPsi5s_CLK_P02_4_OUT;  /**< \brief PSISCLK is a clock that can be used on a pin to drive the external PHY. */
IFX_EXTERN IfxPsi5s_Clk_Out IfxPsi5s_CLK_P33_10_OUT;  /**< \brief PSISCLK is a clock that can be used on a pin to drive the external PHY. */
