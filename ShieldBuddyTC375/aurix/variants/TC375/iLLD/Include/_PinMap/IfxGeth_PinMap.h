...
IFX_EXTERN IfxGeth_Rxclk_In IfxGeth1_RXCLKA_P22_5_IN;  /**< \brief Receive Clock MII and RGMII (RGMII can use RXCLKA only) */
IFX_EXTERN IfxGeth_Rxclk_In IfxGeth1_RXCLKB_P22_12_IN;  /**< \brief Receive Clock MII and RGMII (RGMII can use RXCLKA only) */
IFX_EXTERN IfxGeth_Rxclk_In IfxGeth1_RXCLKC_P22_8_IN;  /**< \brief Receive Clock MII and RGMII (RGMII can use RXCLKA only) */
IFX_EXTERN IfxGeth_Rxclk_In IfxGeth_RXCLKA_P11_12_IN;  /**< \brief Receive Clock MII and RGMII (RGMII can use RXCLKA only) */
IFX_EXTERN IfxGeth_Rxclk_In IfxGeth_RXCLKB_P11_4_IN;  /**< \brief Receive Clock MII and RGMII (RGMII can use RXCLKA only) */
IFX_EXTERN IfxGeth_Rxclk_In IfxGeth_RXCLKC_P12_0_IN;  /**< \brief Receive Clock MII and RGMII (RGMII can use RXCLKA only) */
...
IFX_EXTERN IfxGeth_Txclk_Out IfxGeth1_TXCLK_P22_12_OUT;  /**< \brief  */
IFX_EXTERN IfxGeth_Txclk_Out IfxGeth_TXCLK_P11_4_OUT;  /**< \brief  */
IFX_EXTERN IfxGeth_Txctl_Out IfxGeth1_TXCTL_P22_11_OUT;  /**< \brief GETH1_TXEN 0:  */
IFX_EXTERN IfxGeth_Txctl_Out IfxGeth_TXCTL_P11_6_OUT;  /**< \brief GETH_TXEN 0:  */
IFX_EXTERN IfxGeth_Txd_Out IfxGeth1_TXD0_P22_10_OUT;  /**< \brief  */
IFX_EXTERN IfxGeth_Txd_Out IfxGeth1_TXD1_P23_4_OUT;  /**< \brief  */
IFX_EXTERN IfxGeth_Txd_Out IfxGeth1_TXD2_P23_3_OUT;  /**< \brief  */
IFX_EXTERN IfxGeth_Txd_Out IfxGeth1_TXD3_P23_2_OUT;  /**< \brief  */
IFX_EXTERN IfxGeth_Txd_Out IfxGeth_TXD0_P11_3_OUT;  /**< \brief  */
IFX_EXTERN IfxGeth_Txd_Out IfxGeth_TXD1_P11_2_OUT;  /**< \brief  */
IFX_EXTERN IfxGeth_Txd_Out IfxGeth_TXD2_P11_1_OUT;  /**< \brief  */
IFX_EXTERN IfxGeth_Txd_Out IfxGeth_TXD3_P11_0_OUT;  /**< \brief  */
IFX_EXTERN IfxGeth_Txen_Out IfxGeth1_TXEN_P22_11_OUT;  /**< \brief  */
IFX_EXTERN IfxGeth_Txen_Out IfxGeth_TXEN_P11_6_OUT;  /**< \brief  */
