 ...
 * \param asclin pointer to ASCLIN registers
 */
IFX_EXTERN  Ifx_SRC_SRCR * IfxAsclin_getSrcPointerEr(Ifx_ASCLIN *asclin);

/** \brief Returns the  SRC pointer for Rx
 * \param asclin pointer to ASCLIN registers
 */
IFX_EXTERN  Ifx_SRC_SRCR * IfxAsclin_getSrcPointerRx(Ifx_ASCLIN *asclin);

/** \brief Returns the SRC pointer for Tx
 * \param asclin pointer to ASCLIN registers
 */
IFX_EXTERN  Ifx_SRC_SRCR * IfxAsclin_getSrcPointerTx(Ifx_ASCLIN *asclin);
