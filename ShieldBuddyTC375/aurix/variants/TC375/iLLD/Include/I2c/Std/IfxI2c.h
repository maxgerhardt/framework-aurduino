...
typedef enum
{
    ...
    IfxI2c_DtrInterruptSource_lastBurstRequest  = IFX_I2C_IMSC_L_OFF,  /**< \brief last burst service request */
    IfxI2c_DtrInterruptSource_burstRequest      = IFX_I2C_IMSC__OFF    /**< \brief burst service request */
